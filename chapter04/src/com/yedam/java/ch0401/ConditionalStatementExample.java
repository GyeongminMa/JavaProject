...
public class ConditionalStatementExample {
	...
	public static void main(String[] args) {
		...
		if(score < 90) {
			System.out.println("점수가 90보다 큽니다.");//밑에 한줄까지는 중괄호 없어도 인정됨 두번째줄은 안됨
		...
		//char 타입의 switch문
		//쇼핑몰 : 우수회원 - A/일반회원 -B /둘다 아니면 손님
		//char 타입의 경우 A 는 a 가 될수도 있음 사용자가 입력할수있는 모두 경우의 수 고려
		char grade = 'B';
